...
| `ZENDESK_EMAIL` | `ast configure` | Zendesk agent email address |
...
Unit tests cover Google OAuth token refresh, Calendar event mapping, Zendesk search, and HubSpot deal mapping using mocked `fetch`.
