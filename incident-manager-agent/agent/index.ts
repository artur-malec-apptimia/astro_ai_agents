...
const fetchIncidentsFromNotionTool = createTool({
  ...
  execute: async () => {
    return JSON.stringify(await fetchIncidentsFromNotion(notionApiKey(), notionDatabaseId()));
  },
});
...
const createIncidentInNotionTool = createTool({
  ...
  execute: async (data: {
    ...
    return JSON.stringify(await createIncidentInNotion(notionApiKey(), notionDatabaseId(), data));
  },
});
...
const updateIncidentInNotionTool = createTool({
  ...
  execute: async ({
    ...
    return JSON.stringify(await updateIncidentInNotion(notionApiKey(), page_id, data));
  },
});
